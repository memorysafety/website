...
Alternatively, if the Contest ends (per Section 3) prior to the achievement of performance parity between the rav1d main branch and dav1d v1.5.1, a portion of the total available prize pool commensurate with progress towards parity will be awarded, at the Panel's discretion, for performance improvements made. For example - if a 5% performance gap at the start of the Contest is reduced to a 2% performance gap, 60% of the total prize pool may be available to be awarded.
