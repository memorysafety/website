    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        "inline" === st.css(e, "display") &&
          "none" === st.css(e, "float") &&
          (st.support.inlineBlockNeedsLayout && "inline" !== S(e.nodeName) ? (d.zoom = 1) : (d.display = "inline-block"))),
      n.overflow &&
        ((d.overflow = "hidden"),
              ...
              (r = s[n]),
                ...
                s !== i &&
                  (c && i && (st.isPlainObject(i) || (o = st.isArray(i)))
                    ? (o ? ((o = !1), (a = r && st.isArray(r) ? r : [])) : (a = r && st.isPlainObject(r) ? r : {}), (s[n] = st.extend(c, a, i)))
                    : i !== t && (s[n] = i));
        return s;
      }),
    st.extend({
  ...
  st.extend({
    ...
    st.extend({
      queue: function (e, n, r) {
        var i;
        return e
          ? ((n = (n || "fx") + "queue"), (i = st._data(e, n)), r && (!i || st.isArray(r) ? (i = st._data(e, n, st.makeArray(r))) : i.push(r)), i || [])
          : t;
      },
      ...
      return this instanceof st.Event
        ? (e && e.type
            ? ((this.originalEvent = e),
              (this.type = e.type),
              (this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || (e.getPreventDefault && e.getPreventDefault()) ? u : l))
            : (this.type = e),
          n && st.extend(this, n),
            ...
            return r !== L && 9 === r.nodeType && r.documentElement
              ? ((L = r),
                ...
                (C.attrHandle = o(function (e) {
                  return (
                    (e.innerHTML = "<a href='#'></a>"), e.firstChild && typeof e.firstChild.getAttribute !== V && "#" === e.firstChild.getAttribute("href")
                  );
                })
                  ? {}
                  : {
                ...
                (W.matchesSelector = n(
                  (F = H.matchesSelector || H.mozMatchesSelector || H.webkitMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)
                )) &&
                  o(function (e) {
                  ...
                  : function (t, n, u) {
                      ...
                      if (m) {
                        ...
                        if (((h = [a ? m.firstChild : m.lastChild]), a && v)) {
                          for (
                            c = m[P] || (m[P] = {}), l = c[e] || [], d = l[0] === $ && l[1], p = l[0] === $ && l[2], f = d && m.childNodes[d];
    ...
    st.support.opacity ||
      (st.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            ((t >= 1 || "" === t) && "" === st.trim(o.replace(fn, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || (r && !r.filter))) ||
      ...
      ajax: function (e, n) {
        function r(e, n, r, s) {
          ...
          2 !== x &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (p.ifModified &&
                  ((T = w.getResponseHeader("Last-Modified")), T && (st.lastModified[o] = T), (T = w.getResponseHeader("etag")), T && (st.etag[o] = T)),
        ...
        if (
          ...
          null == p.crossDomain &&
            ...
            (p.crossDomain = !(
              !l ||
              (l[1] === jn[1] && l[2] === jn[2] && (l[3] || ("http:" === l[1] ? 80 : 443)) == (jn[3] || ("http:" === jn[1] ? 80 : 443)))
            ))),
        ...
        (c = p.global),
          ...
          p.ifModified &&
            (st.lastModified[o] && w.setRequestHeader("If-Modified-Since", st.lastModified[o]), st.etag[o] && w.setRequestHeader("If-None-Match", st.etag[o])),
          ((p.data && p.hasContent && p.contentType !== !1) || n.contentType) && w.setRequestHeader("Content-Type", p.contentType),
          w.setRequestHeader(
            "Accept",
            p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + In + "; q=0.01" : "") : p.accepts["*"]
          );
        ...
        var E,
          ...
          _ = function (t, r, a) {
            ...
            return (
              ...
              "string" == typeof o &&
                ("json" === r || (!r && n.indexOf("json") >= 0) ? (o = C(o)) : ("script" === r || (!r && n.indexOf("javascript") >= 0)) && e.globalEval(o)),
              o
            );
          };
        return S;
      ...
      for (c = 0, p = u.length; p > c; c++)
        if (((d = u[c]), (f = d.name), f && !d.disabled))
          if (t && o.clk && "image" == d.type)
            o.clk == d &&
              (a.push({ name: f, value: e(d).val(), type: d.type }), a.push({ name: f + ".x", value: o.clk_x }, { name: f + ".y", value: o.clk_y }));
        ...
        showLabel: function (b, c) {
          ...
          d.length
            ...
            !c &&
              ...
              (d.text(""), "string" == typeof this.settings.success ? d.addClass(this.settings.success) : this.settings.success(d, b)),
          ...
          a.each(["rangelength", "range"], function () {
            ...
            b[this] &&
              (a.isArray(b[this])
                ...
                : "string" == typeof b[this] && ((c = b[this].split(/[\s,]+/)), (b[this] = [Number(c[0]), Number(c[1])])));
          }),
          a.validator.autoCreateRanges &&
            (b.min && b.max && ((b.range = [b.min, b.max]), delete b.min, delete b.max),
            b.minlength && b.maxlength && ((b.rangelength = [b.minlength, b.maxlength]), delete b.minlength, delete b.maxlength)),
          b
        );
      },
...
(function ($) {
  ...
  $.validator.addMethod(
    "PRIVACYPOL",
    function (value, element, grouping_class) {
      var val = $("input[name='PRIVACYPOL']:checked").val();
      return val == "I agree to ISRG handling my info as stated in the policy above.";
    },
...
(function ($) {
    ...
    mce_success_cb: function (resp) {
      ...
      if (resp.result == "success") {
        ...
        $("#mc-embedded-subscribe-form")
          ...
          .addClass("mc-form-did-submit");

        $(".mc-field-group,#mc-embedded-subscribe").slideUp();
  ...
  $.validator.addClassRules("PRIVACYPOL", { PRIVACYPOL: ".PRIVACYPOL" });
